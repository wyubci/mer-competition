...
from asac_merps.features import discover_subjects, load_training_features, standardize_from_train
from asac_merps.model import ASACRegressor


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the MER_PS ASAC baseline.")
    parser.add_argument("--data-root", default="/root/megrez-tmp/MER_PS_codabench_public_trainval")
    parser.add_argument("--output-dir", default="/root/megrez-tmp/codabench/mer_ps_asac_baseline_full")
